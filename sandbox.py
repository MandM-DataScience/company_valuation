...
def test_html():
    ...
    raw_html = '<span style="color:#000000;font-family:\'Times New Roman\',sans-serif;font-size:10pt;font-weight:400;line-height:100%">Item&nbsp;1</span>'
    text_string = BeautifulSoup(raw_html, "html.parser").text
    print(f"'{text_string.lower()}'" )
